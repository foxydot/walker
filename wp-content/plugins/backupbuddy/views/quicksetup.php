...
<script type="text/javascript">
	jQuery(document).ready(function() {
		...
		jQuery( '#pb_backupbuddy_quickstart_password, #pb_backupbuddy_quickstart_passwordconfirm' ).change( function() {
...
<!--			<p>You need to create a password to protect your backups so only you can restore them.</p> -->
			...
			<div class="input-float">
				...
				<img src="<?php echo pb_backupbuddy::plugin_url(); ?>/images/check.png" class="check" id="pb_backupbuddy_quickstart_password_check" />
			</div>
