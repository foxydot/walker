(function($){
    SlideDeckLens['heat-it-up'] = function(slidedeck){
    ...
    $(document).ready(function(){
        $('.lens-heat-it-up .slidedeck').each(function(){
            if(typeof($.data(this, 'lens-heat-it-up')) == 'undefined' || $.data(this, 'lens-heat-it-up') == null){
                $.data(this, 'lens-heat-it-up', new SlideDeckLens['heat-it-up'](this));
            }
        });
    });
})(jQuery);